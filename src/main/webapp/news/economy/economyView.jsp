...
<%
    ...
    int updated = dao.increaseReadcount(num);
	if (updated != 1) {out.println("<!-- 조회수 증가 실패: 업데이트된 행 개수 = " + updated + " -->");	 			    } 				 
...
<div class="container p-4"> 
      ...
      <td>
	    ...
	    <% if (fileList != null && !fileList.isEmpty()) {
	         for (ArticleFileDTO fileDto : fileList) { %>
	           <img src="<%= ctx %>/upload/<%= fileDto.getFile_name() %>"
  ...
  <div class="mt-3 text-center">
    <a href="<%= ctx %>/news/economy/economyList.jsp" class="btn btn-secondary">[목록으로]</a>
